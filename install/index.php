...
<p>Теперь ты можешь перейти на <a href=".HOME.">главную</a> страницу сайта или войти в <a href=".HOME."/singin>личный кабинет</a>(login: my@mail.dn / без пароля) и обновить свои данные</p>";
endif;
  endif;
?>
</body>
